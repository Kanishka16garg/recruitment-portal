                  ...
                  <div className="card" key={element._id}>
                    ...
                    <p style={{ marginTop: "0.5rem" }}>
                      {element.status === "accepted" && (
                        <span>
                          Your application has been accepted! You will receive
                          further information on your email or phone.
                        </span>
                      )}
                      {element.status === "rejected" && (
                        <span>
                          Unfortunately, your application wasn’t selected this
                          time — don’t lose hope! Keep trying and improving.
                        </span>
                      )}
                      {element.status === "pending" && (
                        <span>Your application is still under review.</span>
                      )}
                    </p>
